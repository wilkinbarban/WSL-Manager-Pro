...
[![CI](https://github.com/username/wsl-manager-pro/actions/workflows/ci.yml/badge.svg)](https://github.com/username/wsl-manager-pro/actions/workflows/ci.yml)
...
| `es` | Español (Spanish) | `resources/i18n/es.json` |
| `pt` | Português (Brazilian) | `resources/i18n/pt.json` |
